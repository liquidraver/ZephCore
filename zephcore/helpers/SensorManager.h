...
// ZEPHCORE: no LocationProvider class -- the GPS manager is C
// (adapters/gps/ZephyrGPSManager.h). getLocationProvider() stays, returning
// NULL, so ported callers compile.
#include <string.h>
